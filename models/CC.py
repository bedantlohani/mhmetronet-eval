...
class CrowdCounter(nn.Module):
    def __init__(self,gpus,model_name):
        ...
        if model_name == 'AlexNet':
            ...
            from .SCC_Model.EfficientNet import EffNetb5 as net
        elif model_name == 'Res152':
            from .SCC_Model.Res152 import Res152 as net
        elif model_name == 'Dens121':
            from .SCC_Model.Dens121 import Dens121 as net
        elif model_name == 'Senet154':
            from .SCC_Model.Senet154 import Senet154 as net
        elif model_name == 'Seresnet50':
            from .SCC_Model.Seresnet50 import Seresnet50 as net
        elif model_name == 'Res504blocks':
            from .SCC_Model.Res504blocks import Res504blocks as net

...
elif data_mode is 'METRO':
    from datasets.METRO.loading_data import loading_data
    from datasets.METRO.setting import cfg_data 


#------------Prepare Trainer------------
net = cfg.NET
print(net)
if net in ['MCNN', 'AlexNet', 'VGG', 'VGG_DECODER', 'Res50', 'Res101', 'CSRNet','Res101_SFCN', 'EffNet-b5', 'Res152', 'Dens121', 'Senet154', 'Seresnet50', 'Res504blocks']:
    from trainer import Trainer
elif net in ['SANet']: 
